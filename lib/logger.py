...
class Logger:
    file_name = f"/Users/elizavetafilippova/PycharmProjects/LearnQA_Python_API/logs/log_" + str(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")) + ".log"
    ...
    def add_request(cls, url: str, data: dict, headers: dict, cookies: dict, method: str):
        ...
        data_to_add += f"Date: {str(datetime.datetime.now())}\n"
